...
parser.add_argument("-E", "--excision_end", type=str, required=False, help="1-based nucleotide that is the last to delete.")
args = parser.parse_args()


# Harmless defaults
splice_in = ''
excision_start = 0 # left closed
excision_end = 0   # right open
...
if args.insert:
    ...
    # The 1-based right-closed index after which to cut (human) is the same as the 0-based right-open substring end before the cut (python)
...
if args.excision_start and args.excision_end:
    ...
    excision_start -= 1
    # No need to change the end coordinate. The 1-based right-closed index is the same as the 0-based right-open substring end.
