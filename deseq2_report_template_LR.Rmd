...
if (is.null(params$reducedFormula)) {
  ...
  reslr <- results(deobj, independentFiltering = params$filterBaseMean, alpha=params$pcutoff, lfcThreshold=params$lfcthreshold, altHypothesis=params$althyp)[, c('baseMean', 'pvalue', 'padj')] 
