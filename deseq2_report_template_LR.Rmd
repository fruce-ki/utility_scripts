...
do_de_plots <- function(contrast, dds = deobj, rpms = tpm, regcnt=vstmat, ntop = params$ntop, addPrefix = params$longlabel,
  ...
  keep <- c("name", "baseMean", "FC", "pvalue", "padj",
             ...
             "log2FoldChange", "log2FoldChange.shrink",  "mlog10p", "maxCount", "maxScaledCount")     # convenience fields for plotting or filtering
  ...
  return(list(contrast=ctrname, 
              ...
              pe1=pe1, pe2=pe2, pe3=pe3, pe4=pe4, #pe1ly=ggplotly(pe1ly, dynamicTicks = TRUE),
              ph1=ph1, ph2=ph2, 
