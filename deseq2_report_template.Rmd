...
* Red triangles for top `r params$ntop` (or fewer) hits.
...
* Black dots for everything else.
* Solid black dots (in MA plots) for signicant FDRs.
* Faded/transparent black dots (in MA plots) for non-significant FDRs.
