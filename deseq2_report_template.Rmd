...
```{r functionC}
# Correlations
my_pairwise_internal_corels <- function(mat = counts(deobj), method = "pearson") {
  # Correlations
...
do_pca <- function(countsmat = rpm, covars = colData(deobj), center = TRUE, scale = TRUE, loadthresh = params$minL){
  # Gene variances
