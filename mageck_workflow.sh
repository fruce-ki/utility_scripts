...
$counts="${countsdir}/counts/${library/txt/$empty}/counts_mageck.txt"
...
fileutilities.py T $library ${lib}/entrez.txt --appnd -r > ${library}_entrez.txt
...
Rscript ./analysis/p2log10p.R $out $l10
