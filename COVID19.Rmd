...
agecasenat <- fread('agecasesnational.csv')[country != 'Cases_on_an_international_conveyance_Japan', ]
agecasesubnat <- fread('agecasesubnational.csv') # [country != 'Cases_on_an_international_conveyance_Japan',] # Still blank
casedist <- fread('casedistribution.csv')[countriesAndTerritories != 'Cases_on_an_international_conveyance_Japan', ]
hosprate <- fread('hospitalicuadmissionrates.csv')[country != 'Cases_on_an_international_conveyance_Japan', ]
movement <- fread('movementindicators.csv')[country != 'Cases_on_an_international_conveyance_Japan', ]
natcasedeath <- fread('nationalcasedeath.csv')[country != 'Cases_on_an_international_conveyance_Japan', ]
subnatcaseday <- fread('subnationalcasedaily.csv')[country != 'Cases_on_an_international_conveyance_Japan', ]
subnatcaseweek <- fread('subnationalcaseweekly.csv')[country != 'Cases_on_an_international_conveyance_Japan', ]
testing <- fread('testing.csv')[country != 'Cases_on_an_international_conveyance_Japan', ]
...
# world_map[region=='Virgin_Islands', region := 'British_Virgin_Islands']       # 
# world_map[region=='Virgin_Islands', region := 'United_States_Virgin_Islands'] # 
